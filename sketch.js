...
function setup() {
  ...
  goalKeeper1 = new Goalkeeper(750,150,20,20);
  goalKeeper1.shapeColor = "red";
  goalKeeper2 = new Goalkeeper(200,480,20,20);
  goalKeeper2.shapeColor = "blue";
  goalKeeper3 = new Goalkeeper(720,760,20,20);
  goalKeeper3.shapeColor = "pink";
  goalKeeper4 = new Goalkeeper(1300,500,20,20);
...
function draw() {
  ...
  //goalKeeperLeftMovement(goalKeeper1);
  //goalKeeperDownMovement(goalKeeper)
  //goalKeeperRightMovement(goalKeeper3);
...
function caltimer(){
  if(frameCount % 60 === 0 && goalTimer > 0){
    goalTimer --;
  }
}
